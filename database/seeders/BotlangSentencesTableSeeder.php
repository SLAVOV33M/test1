...
class BotlangSentencesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $sentences = [
            ...
            // ],
            [
                'name' => 'cmd.steam.wrongsteamid',
                'sentences' => ['en' => 'Your steamid is wrong!']
            ],
            [
                'name' => 'cmd.steam.notplaying',
                'sentences' => ['en' => 'You are not playing at this moment.']
            ],
            [
                'name' => 'cmd.steam.nosteamid',
                'sentences' => ['en' => 'Please, set a steamid in panel.']
            ],
            [
                'name' => 'cmd.steam.isplaying',
                'sentences' => ['en' => '$0 is playing $1']
            ]
        ];
